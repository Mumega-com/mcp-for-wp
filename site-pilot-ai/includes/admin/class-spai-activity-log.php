...
class Spai_Activity_Log_Page {
	...
	public function render() {
		...
		echo '<div class="wrap">';
		echo '<h1>' . esc_html__( 'Site Pilot AI Activity Log', 'site-pilot-ai' ) . '</h1>';
		...
		if ( ! $enabled ) {
			echo '<div class="notice notice-warning"><p>' .
				esc_html__( 'Activity logging is currently disabled. Enable it in Site Pilot AI settings to capture new entries.', 'site-pilot-ai' ) .
				'</p></div>';
		}
