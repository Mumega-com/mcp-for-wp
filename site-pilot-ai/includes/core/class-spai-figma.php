...
class Spai_Figma {
	...
	private function get_config() {
		...
		if ( ! is_array( $config ) ) {
			return new WP_Error( 'figma_not_configured', __( 'Figma is not configured. Add a personal token or OAuth app in Site Pilot AI → Integrations.', 'site-pilot-ai' ) );
		}
	...
	private function get_access_token() {
		...
		return new WP_Error( 'figma_not_configured', __( 'Figma is not configured. Add a personal token or complete the OAuth connection in Site Pilot AI → Integrations.', 'site-pilot-ai' ) );
	}
