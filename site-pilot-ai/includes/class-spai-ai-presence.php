...
class Spai_AI_Presence {
	...
	public function generate_llms_txt() {
		...
		if ( '' !== $site_context ) {
			...
			$lines[] = '';
			$lines[] = '## Site Character';
			$lines[] = 'No explicit AI site context is configured yet. Use the Site Pilot AI settings to define the brand voice, design system, target audience, and recurring page patterns.';
		}
