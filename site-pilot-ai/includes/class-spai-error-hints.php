	...
	private static function get_hint_map( $context = array() ) {
		...
		return array(
			...
			'rate_limit_exceeded' => array(
				'hint'  => 'Rate limit exceeded. Wait for the Retry-After period indicated in the response headers. To increase limits, the site admin can adjust settings in WP Admin > Site Pilot AI > Settings, or create a key with custom rate_limits.',
				'guide' => '',
			),
